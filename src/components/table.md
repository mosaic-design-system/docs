  ...
  - title: Usage
    body: >-
      ...
      **Tables** consist of logical rows and columns to help users easily find and reference sections of data.
      ...
      | **With Checkbox**         | [Selectors](/forms/checkbox) in Tables are there to help with selecting rows, in order to interact with specific cells - the Checkbox highlights the desired cells and helps the user visualise the impact of their actions |
