...
tabs:
  - title: Usage
    body: >-
      ...
      **Button types** can be applied to a **Button** to give some additional functionality to the **Button**.
      ...
      | **Outline**       | **Outline Buttons** are not full-colour buttons – instead, they are just a **Button** outline. This is useful when the **Button** is on a page that has a coloured background.                                                                                                                                                                                                                                                                                                                                                                                              | 
      ...
      Context helps convey the information being communicated. Button contexts correspond to a colour to provide a consistent experience for users. For more information, refer to the Colours guidelines.
      ...
      | **Primary**   | Used for the main CTA on the screen. This is reserved for actions such as add, import or save. There should only ever be one **Primary Button** on the page, **Form** or **Card**                                                                                                                                                            | 
