  ...
  - title: Usage
    body: >-
      ...
      **Button types** can be applied to a **Button** to give some additional functionality to the **Button**.
      ...
      | **Secondary** | Buttons that do not fall into one of the other categories. This can be used for things that are largely inconsequential but necessary, like closing a dialogue box. The **Outline** button is used for all secondary actions.                                                                                                                |
