...
tabs:
  - title: Usage
    body: >-
      ...
      | Actionable | An Alert but contains an action that the user can perform. Applies to any of the above Alert types | Persists until the action has been performed                                                                                                                                                            | Positioned as per the desired Alert type above                                                                                                                         |
