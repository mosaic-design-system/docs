  ...
  - title: Overview
    body: >-
      ...
      * We want our products to be able to adapt to any type of user in any environment, and in any context
      ...
      <a href="accessibility-statement-template.docx.zip" target="_blank" class="mcc=button--primary"><span class="mcc-button__label">Download our accessibility guidelines for visual elements</span></a>


      <a href="accessibility-statement-template.docx.zip" target="_blank" class="mcc=button--primary"><span class="mcc-button__label">Download our accessibility guidelines for code elements</span></a>
  - title: Keyboards
